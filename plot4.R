...
## Task: Draw 4th plot into plot4.png file
##
## USAGE:
...
##  4) Source plot4.R file:
##      source("plot4.R")
##  5) Run plot4 function:
##      plot4()
...
draw_to_png_4 <- function(data) {
    ...
    ## Plot 2-1
    plot(data$Time, data$Voltage, type = "s",
         xlab = "datetime",
         ylab = "Voltage")
    
    ## Plot 2-2
    plot(data$Time, data$Global_reactive_power, type = "s",
         xlab = "datetime",
